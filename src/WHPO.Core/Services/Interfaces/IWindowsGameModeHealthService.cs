...
public enum WindowsGameModeHealth
{
    ...
    DisabledByRules = 1,
    /// <summary>Huérfano: faltan archivos/componentes del Modo Juego (Appx XboxGamingOverlay o el Presence Writer de Game Bar en System32). No se puede activar por registro.</summary>
    Orphaned = 2,
...
public sealed record WindowsGameModeHealthInfo(
    ...
    /// <summary>Presence Writer de Game Bar en System32 presente (GameBarPresenceWriter.dll/exe/.proxy.dll según el build de Windows).</summary>
