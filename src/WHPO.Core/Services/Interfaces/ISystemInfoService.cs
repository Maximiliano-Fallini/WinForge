...
/// <summary>
/// Estado de las funciones de seguridad del firmware (TPM, Secure Boot, IOMMU, VBS).
/// UefiFirmware es true cuando el sistema arrancó en UEFI (Secure Boot solo aplica ahí).
/// VbsStatus (fuente: Win32_DeviceGuard): 0 = desactivado, 1 = configurado pero no en
/// ejecución, 2 = en ejecución, -1 = DESCONOCIDO (no se pudo leer: namespace/clase
/// DeviceGuard ausente o WMI dañado — no se puede afirmar que esté desactivado).
/// HvciRunning: Integridad de memoria (HVCI) corriendo AHORA. HvciConfigured: HVCI
/// pedido pero sin ejecutar (p. ej. VBS habilitado sin arrancar el hipervisor, o un
/// driver incompatible que lo desactivó).
/// </summary>
