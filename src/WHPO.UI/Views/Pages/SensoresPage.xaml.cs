...
/// </summary>
public sealed partial class SensoresPage : Page, IBackgroundPausable
{
    ...
    /// <summary>
    /// Pausa de bandeja (IBackgroundPausable): Stop real del sondeo de 1 s
    /// (cada lectura hace un Update completo de LHM).
    /// </summary>
    ...
    {
        // Sin solapamientos (el timer se para de verdad al ocultar/navegar).
        if (_polling) return;
        _polling = true;
        try
        {
