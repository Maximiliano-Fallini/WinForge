...
/// El vigilante de atajos (MacroHotkeyService) corre desde el arranque de la
/// app, así que los atajos funcionan aunque esta página no se haya visitado.
/// </summary>
public sealed partial class MacrosPage : Page
{
    ...
    protected override void OnNavigatedTo(Microsoft.UI.Xaml.Navigation.NavigationEventArgs e)
    {
        ...
        // Refrescar siempre (pueden cambiar entre visitas). El vigilante de atajos
        // ya corre desde el arranque de la app (MacroHotkeyService); acá solo se
        // asegura de que esté activo y se recargan las armadas.
        try
        {
